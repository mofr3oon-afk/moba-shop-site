...
/* moba-v208-clean-offers-catalog-final */
(function(){
  if(window.__mobaV208CleanOffersCatalog)return; window.__mobaV208CleanOffersCatalog=true;
  ...
  const games=[
    ...
    {key:'blood_mena',title:'Blood Strike MENA',subtitle:'MENA Top Up',currency:'💎',status:'available',sort_order:3,image:'assets/game-covers/blood_mena.jpg',id_label:'Blood Strike ID',id_placeholder:'اكتب ID حساب Blood Strike',name_label:'اسم الحساب داخل اللعبة'},
  ...
  const sections=[
    {game:'pubg',key:'uc',title:'شدات UC',subtitle:'باقات الشحن الأساسية',currency:'UC',location:'game',status:'available',sort_order:1,active:true,id_label:'PUBG ID',id_placeholder:'اكتب PUBG ID',name_label:'اسم الحساب داخل اللعبة'},
    {game:'freefire',key:'diamonds',title:'جواهر Free Fire',subtitle:'شحن فري فاير',currency:'💎',location:'game',status:'available',sort_order:1,active:true,id_label:'Free Fire ID',id_placeholder:'اكتب ID فري فاير',name_label:'اسم الحساب داخل اللعبة'},
    {game:'freefire',key:'ff_membership',title:'عضويات Free Fire',subtitle:'اسبوعية / شهرية / بوياه',currency:'EGP',location:'game',status:'available',sort_order:2,active:true,id_label:'Free Fire ID',id_placeholder:'اكتب ID فري فاير',name_label:'اسم الحساب داخل اللعبة'},
    {game:'blood_mena',key:'blood_diamonds',title:'جواهر Blood Strike',subtitle:'شحن Blood Strike MENA',currency:'💎',location:'game',status:'available',sort_order:1,active:true,id_label:'Blood Strike ID',id_placeholder:'اكتب ID حساب Blood Strike',name_label:'اسم الحساب داخل اللعبة'},
    {game:'blood_mena',key:'blood_elite',title:'Strike Elite',subtitle:'اشتراكات وعروض Blood Strike',currency:'EGP',location:'game',status:'available',sort_order:2,active:true,id_label:'Blood Strike ID',id_placeholder:'اكتب ID حساب Blood Strike',name_label:'اسم الحساب داخل اللعبة'},
    {game:'mobile_legends',key:'ml_diamonds',title:'ألماس Mobile Legends',subtitle:'مطلوب ID + Zone ID',currency:'💎',location:'game',status:'available',sort_order:1,active:true,id_label:'Mobile Legends ID',id_placeholder:'اكتب ID الحساب',name_label:'اسم الحساب',custom_fields:[{key:'zone_id',label:'Zone ID',placeholder:'اكتب Zone ID',type:'numeric',required:true}]},
    {game:'yalla_ludo',key:'yalla_diamonds',title:'جواهر Yalla Ludo',subtitle:'محتاج ID واسم الحساب',currency:'💎',location:'game',status:'available',sort_order:1,active:true,id_label:'Yalla Ludo ID',id_placeholder:'اكتب ID الحساب',name_label:'اسم الحساب'}
  ];
  const p=(id,game,cat,name,price,uc,sort,type,noQty=false)=>({id,game,cat,name,price,uc,sort_order:sort,status:'available',active:true,type,noQty});
  const products=[
    p('pubg_uc_60','pubg','uc','UC 60',50,60,1,'شحن PUBG'),
    p('pubg_uc_325','pubg','uc','UC 325',235,325,2,'شحن PUBG'),
    p('pubg_uc_660','pubg','uc','UC 660',435,660,3,'شحن PUBG'),
    p('pubg_uc_1800','pubg','uc','UC 1800',1120,1800,4,'شحن PUBG'),
    p('pubg_uc_3850','pubg','uc','UC 3850',2170,3850,5,'شحن PUBG'),
    p('pubg_uc_8100','pubg','uc','UC 8100',4350,8100,6,'شحن PUBG'),
    p('ff_50','freefire','diamonds','50 💎',40,50,1,'Free Fire Diamonds'),
    p('ff_100','freefire','diamonds','100 💎',70,100,2,'Free Fire Diamonds'),
    p('ff_210','freefire','diamonds','210 💎',130,210,3,'Free Fire Diamonds'),
    p('ff_310','freefire','diamonds','310 💎',180,310,4,'Free Fire Diamonds'),
    p('ff_583','freefire','diamonds','583 💎',300,583,5,'Free Fire Diamonds'),
    p('ff_1188','freefire','diamonds','1,188 💎',590,1188,6,'Free Fire Diamonds'),
    p('ff_2420','freefire','diamonds','2,420 💎',1140,2420,7,'Free Fire Diamonds'),
    p('ff_6160','freefire','diamonds','6,160 💎',2800,6160,8,'Free Fire Diamonds'),
    p('ff_weekly','freefire','ff_membership','عضوية اسبوعية',130,1,1,'Free Fire Membership',true),
    p('ff_monthly','freefire','ff_membership','عضوية شهرية',570,1,2,'Free Fire Membership',true),
    p('ff_booyah','freefire','ff_membership','تصريح بوياه',180,1,3,'Free Fire Offer',true),
    p('blood_105','blood_mena','blood_diamonds','105 💎',60,105,1,'Blood Strike MENA'),
    p('blood_320','blood_mena','blood_diamonds','320 💎',155,320,2,'Blood Strike MENA'),
    p('blood_540','blood_mena','blood_diamonds','540 💎',260,540,3,'Blood Strike MENA'),
    p('blood_1100','blood_mena','blood_diamonds','1100 💎',475,1100,4,'Blood Strike MENA'),
    p('blood_2260','blood_mena','blood_diamonds','2260 💎',920,2260,5,'Blood Strike MENA'),
    p('blood_5800','blood_mena','blood_diamonds','5800 💎',2300,5800,6,'Blood Strike MENA'),
    p('blood_elite','blood_mena','blood_elite','Strike Elite',225,1,1,'اشتراك Blood Strike',true),
    p('blood_elite_plus','blood_mena','blood_elite','Strike Elite+',475,1,2,'اشتراك Blood Strike',true),
    p('blood_level_offer','blood_mena','blood_elite','عرض المستوى',135,1,3,'عرض Blood Strike',true),
    p('ml_56','mobile_legends','ml_diamonds','56 💎',60,56,1,'Mobile Legends Diamonds'),
    p('ml_172','mobile_legends','ml_diamonds','172 💎',160,172,2,'Mobile Legends Diamonds'),
    p('ml_257','mobile_legends','ml_diamonds','257 💎',250,257,3,'Mobile Legends Diamonds'),
    p('ml_344','mobile_legends','ml_diamonds','344 💎',300,344,4,'Mobile Legends Diamonds'),
    p('ml_706','mobile_legends','ml_diamonds','706 💎',550,706,5,'Mobile Legends Diamonds'),
    p('ml_1346','mobile_legends','ml_diamonds','1346 💎',1000,1346,6,'Mobile Legends Diamonds'),
    p('ml_1825','mobile_legends','ml_diamonds','1825 💎',1400,1825,7,'Mobile Legends Diamonds'),
    p('ml_2195','mobile_legends','ml_diamonds','2195 💎',1750,2195,8,'Mobile Legends Diamonds'),
    p('ml_3688','mobile_legends','ml_diamonds','3688 💎',2750,3688,9,'Mobile Legends Diamonds'),
    p('ml_5532','mobile_legends','ml_diamonds','5532 💎',3900,5532,10,'Mobile Legends Diamonds'),
    p('ml_9288','mobile_legends','ml_diamonds','9288 💎',6500,9288,11,'Mobile Legends Diamonds')
  ];
  function mergeBy(base, extra, keyFn){
    const m=new Map();
    base.forEach(x=>m.set(keyFn(x),{...x}));
    (Array.isArray(extra)?extra:[]).forEach(x=>{const k=keyFn(x); if(k)m.set(k,{...(m.get(k)||{}),...x});});
    return [...m.values()];
  }
  function settings(){
    try{const raw=localStorage.getItem('moba_settings_cache_v198')||localStorage.getItem('moba_settings_cache'); const j=raw?JSON.parse(raw):{}; return j.settings||j||{};}catch(_){return {}}
  }
  function applyCatalog(){
    const s=settings();
    const oldLegacy=new Set(['roblox','blood_global','kingshot','8ball','goal_battle','last_war','efootball','tiktok','valorant']);
    const next={...s};
    next.game_settings=mergeBy(games,(s.game_settings||[]).filter(g=>!oldLegacy.has(String(g.key||g.id||g.game||''))),x=>String(x.key||x.id||x.game||''));
    next.dynamic_sections=mergeBy(sections,s.dynamic_sections,x=>String(x.game||'')+'|'+String(x.key||''));
    next.dynamic_products=mergeBy(products,s.dynamic_products,x=>String(x.game||'')+'|'+String(x.cat||'')+'|'+String(x.id||x.name||''));
    window.__mobaV198Settings=next; window.__mobaV204Settings=next; window.__mobaV208Settings=next;
    window.mobaProducts={};
    next.dynamic_products.forEach(x=>{(window.mobaProducts[x.cat]=window.mobaProducts[x.cat]||[]).push(x);});
    try{localStorage.setItem('moba_settings_cache_v198',JSON.stringify({settings:next,ts:Date.now()}));}catch(_){}
    return next;
  }
  function sourceOffer(){
    const old=document.querySelector('#homeSectionsV198 button,#homeSectionsV195 button,.home-sections-v198 button,.home-sections-v195 button,#exclusiveOfferV168');
    const img=old?.querySelector?.('img')?.getAttribute('src') || 'assets/game-covers/freefire-new.webp';
    return {
      title:(old?.querySelector?.('b')?.textContent||old?.textContent||'عروض شهر 6').trim().replace(/\s+/g,' ').slice(0,48),
      subtitle:(old?.querySelector?.('small')?.textContent||'عروض محدودة على أشهر الباقات').trim().slice(0,80),
      badge:(old?.querySelector?.('span')?.textContent||'متاح الآن').trim().slice(0,20),
      image:img,
      game:old?.dataset?.v198HomeGame||old?.dataset?.v203HomeGame||'pubg',
      cat:old?.dataset?.v198HomeSection||old?.dataset?.v203HomeSection||'uc'
    };
  }
  function renderOffer(){
    const gamesHome=document.getElementById('gamesHome'); if(!gamesHome)return;
    document.querySelectorAll('#homeSectionsV198,#homeSectionsV195,.home-sections-v198,.home-sections-v195,#exclusiveOfferV168').forEach(el=>{if(el.id!=='mobaOffersBannerV208')el.style.display='none';});
    let box=document.getElementById('mobaOffersBannerV208');
    const o=sourceOffer();
    if(!box){box=document.createElement('button'); box.type='button'; box.id='mobaOffersBannerV208'; box.className='moba-offer-banner-v208';}
    box.dataset.game=o.game; box.dataset.cat=o.cat;
    box.innerHTML=`<img src="${esc(o.image)}" alt="${esc(o.title)}" onerror="this.onerror=null;this.src='assets/moba-shop-logo-512.webp'"><span>${esc(o.badge)}</span><b>${esc(o.title)}</b><small>${esc(o.subtitle)}</small><em>اضغط لفتح العرض</em>`;
    const grid=gamesHome.querySelector('.game-cards-grid');
    if(grid&&box.parentElement!==gamesHome)gamesHome.insertBefore(box,grid);
    else if(grid&&box.nextElementSibling!==grid)gamesHome.insertBefore(box,grid);
  }
  function openTarget(game,cat){
    window.activeGame=game||'pubg'; window.activeCat=cat||({pubg:'uc',freefire:'diamonds',blood_mena:'blood_diamonds',mobile_legends:'ml_diamonds',yalla_ludo:'yalla_diamonds'}[window.activeGame]||'uc');
    if(typeof window.mobaShowView==='function')window.mobaShowView('game');
    setTimeout(()=>{try{window.renderProducts&&window.renderProducts();}catch(_){} document.getElementById('productsSection')?.scrollIntoView({behavior:'smooth',block:'start'});},60);
  }
  document.addEventListener('click',function(e){
    const b=e.target.closest&&e.target.closest('#mobaOffersBannerV208');
    if(!b)return;
    e.preventDefault(); e.stopPropagation(); e.stopImmediatePropagation&&e.stopImmediatePropagation();
    openTarget(b.dataset.game,b.dataset.cat);
    return false;
  },true);
  const st=document.createElement('style');
  st.textContent=`
    #homeSectionsV198,#homeSectionsV195,.home-sections-v198,.home-sections-v195,#exclusiveOfferV168{display:none!important}
    #mobaOffersBannerV208{position:relative!important;display:grid!important;align-content:end!important;width:100%!important;min-height:172px!important;margin:22px 0 28px!important;padding:18px 22px!important;border:1px solid rgba(255,216,107,.34)!important;border-radius:24px!important;overflow:hidden!important;text-align:right!important;color:#fff!important;background:#071321!important;box-shadow:0 22px 52px rgba(0,0,0,.38),0 0 0 1px rgba(39,216,255,.12) inset!important;cursor:pointer!important;isolation:isolate!important;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease!important}
    #mobaOffersBannerV208:hover{transform:translateY(-4px)!important;border-color:rgba(255,216,107,.72)!important;box-shadow:0 30px 68px rgba(0,0,0,.46),0 0 30px rgba(255,216,107,.16)!important}
    #mobaOffersBannerV208 img{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;object-fit:cover!important;opacity:.76!important;filter:saturate(1.12) contrast(1.08)!important;z-index:-2!important}
    #mobaOffersBannerV208:after{content:''!important;position:absolute!important;inset:0!important;background:linear-gradient(90deg,rgba(4,10,22,.96),rgba(4,10,22,.62) 44%,rgba(4,10,22,.20))!important;z-index:-1!important}
    #mobaOffersBannerV208 span{width:max-content!important;margin-inline-start:auto!important;background:#54e6b0!important;color:#061421!important;border-radius:999px!important;padding:7px 12px!important;font-size:12px!important;font-weight:1000!important;box-shadow:0 10px 24px rgba(0,0,0,.24)!important}
    #mobaOffersBannerV208 b{display:block!important;margin-top:18px!important;font-size:28px!important;line-height:1.1!important;text-shadow:0 3px 16px rgba(0,0,0,.72)!important}
    #mobaOffersBannerV208 small{display:block!important;margin-top:8px!important;color:#e6f7ff!important;font-size:14px!important;line-height:1.6!important;text-shadow:0 2px 12px rgba(0,0,0,.65)!important}
    #mobaOffersBannerV208 em{display:inline-flex!important;width:max-content!important;margin-top:12px!important;margin-inline-start:auto!important;font-style:normal!important;color:#ffe08a!important;font-size:12px!important;font-weight:900!important}
    @media(max-width:680px){#mobaOffersBannerV208{min-height:146px!important;margin:16px 0 22px!important;padding:15px!important;border-radius:20px!important}#mobaOffersBannerV208 b{font-size:21px!important;margin-top:14px!important}#mobaOffersBannerV208 small{font-size:12px!important;line-height:1.5!important}#mobaOffersBannerV208 em{font-size:11px!important}}
  `;
  document.head.appendChild(st);
  function run(){applyCatalog();renderOffer();}
  window.__mobaV208ApplyCatalog=applyCatalog;
  window.__mobaV208RenderOffer=renderOffer;
...
/* moba-v206-premium-home-offers-and-games-final */
(function(){
  if(window.__mobaV206PremiumHomeFinal)return; window.__mobaV206PremiumHomeFinal=true;
  const games=[
  ...
  const cat={pubg:'uc',freefire:'diamonds',blood_mena:'blood_diamonds',mobile_legends:'ml_diamonds',yalla_ludo:'yalla_diamonds'};
  const esc=v=>String(v??'').replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]));
  function renderGamesFinal(){
    const grid=document.querySelector('#gamesHome .game-cards-grid'); if(!grid)return;
    const html=games.map(g=>`<button type="button" class="moba-game-tile-v206" data-v206-game="${esc(g[0])}"><img src="${esc(g[3])}" alt="${esc(g[1])}" onerror="this.onerror=null;this.src='assets/moba-shop-logo-512.webp'"><span class="shade"></span><em>متاح الآن</em><b>${esc(g[1])}</b><small>${esc(g[2])}</small></button>`).join('');
    if(grid.innerHTML!==html){grid.innerHTML=html;}
  }
  function openGame(game){
    window.activeGame=game||'pubg';
    window.activeCat=cat[window.activeGame]||'uc';
    if(typeof window.mobaShowView==='function')window.mobaShowView('game');
    setTimeout(()=>{try{window.renderProducts&&window.renderProducts();}catch(_){} document.getElementById('productsSection')?.scrollIntoView({behavior:'smooth',block:'start'});},60);
  }
  function normalizeOffers(){
    const boxes=[...document.querySelectorAll('#homeSectionsV198,#homeSectionsV195,.home-sections-v198,.home-sections-v195')].filter(Boolean);
    boxes.forEach(box=>{
      box.classList.add('home-offers-wide-v206');
      [...box.querySelectorAll('button')].forEach(btn=>{
        btn.classList.add('home-offer-banner-v206');
        btn.style.borderRadius='';
      });
    });
  }
  document.addEventListener('click',function(e){
    const game=e.target.closest&&e.target.closest('[data-v206-game]');
    if(game){e.preventDefault();e.stopPropagation();e.stopImmediatePropagation&&e.stopImmediatePropagation();openGame(game.dataset.v206Game);return false;}
    const offer=e.target.closest&&e.target.closest('.home-offer-banner-v206,[data-v198-home-section],[data-v203-home-section],#exclusiveOfferV168');
    if(offer){e.preventDefault();e.stopPropagation();e.stopImmediatePropagation&&e.stopImmediatePropagation();window.activeGame=offer.dataset?.v198HomeGame||offer.dataset?.v203HomeGame||window.activeGame||'pubg';window.activeCat=offer.dataset?.v198HomeSection||offer.dataset?.v203HomeSection||window.activeCat||cat[window.activeGame]||'uc';if(typeof window.mobaShowView==='function')window.mobaShowView('game');setTimeout(()=>{try{window.renderProducts&&window.renderProducts();}catch(_){}document.getElementById('productsSection')?.scrollIntoView({behavior:'smooth',block:'start'});},60);return false;}
  },true);
  const style=document.createElement('style');
  style.textContent=`
    #gamesHome .game-card,#gamesHome .moba-game-tile-v203,#gamesHome .moba-game-tile-v204,#gamesHome .moba-game-tile-v205,#gamesHome .moba-game-tile-hard{display:none!important}
    #gamesHome .game-cards-grid{display:grid!important;grid-template-columns:repeat(auto-fit,minmax(310px,1fr))!important;gap:24px!important;padding:24px 0 10px!important;align-items:stretch!important;min-height:0!important}
    #gamesHome .moba-game-tile-v206{position:relative!important;display:block!important;min-height:184px!important;aspect-ratio:16/9!important;overflow:hidden!important;border:1px solid rgba(73,219,255,.34)!important;border-radius:24px!important;background:#071321!important;color:#fff!important;text-align:start!important;padding:0!important;box-shadow:0 20px 48px rgba(0,0,0,.35),0 0 0 1px rgba(255,216,107,.08) inset!important;cursor:pointer!important;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease,filter .18s ease!important}
    #gamesHome .moba-game-tile-v206:hover{transform:translateY(-5px)!important;border-color:rgba(255,216,107,.62)!important;box-shadow:0 28px 62px rgba(0,0,0,.43),0 0 26px rgba(255,216,107,.16)!important}
    #gamesHome .moba-game-tile-v206:active{transform:translateY(1px) scale(.985)!important;filter:brightness(.93)!important}
    #gamesHome .moba-game-tile-v206 img{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;object-fit:cover!important;filter:saturate(1.08) contrast(1.05)!important}
    #gamesHome .moba-game-tile-v206 .shade{position:absolute!important;inset:0!important;background:linear-gradient(90deg,rgba(3,8,18,.95),rgba(3,8,18,.33) 58%,rgba(3,8,18,.72))!important}
    #gamesHome .moba-game-tile-v206 b{position:absolute!important;right:22px!important;left:22px!important;bottom:48px!important;font-size:23px!important;line-height:1.15!important;letter-spacing:0!important;text-shadow:0 3px 14px rgba(0,0,0,.72)!important}
    #gamesHome .moba-game-tile-v206 small{position:absolute!important;right:22px!important;left:22px!important;bottom:22px!important;color:#d9efff!important;font-size:13px!important;text-shadow:0 2px 12px rgba(0,0,0,.65)!important}
    #gamesHome .moba-game-tile-v206 em{position:absolute!important;right:16px!important;top:14px!important;font-style:normal!important;padding:8px 13px!important;border-radius:999px!important;background:#54e6b0!important;color:#061421!important;font-weight:900!important;font-size:12px!important;box-shadow:0 10px 24px rgba(0,0,0,.22)!important}
    body.moba-page-booting #gamesHome .game-cards-grid,body:not(.moba-settings-ready) #gamesHome .game-cards-grid{opacity:1!important;pointer-events:auto!important;min-height:0!important}
    #homeSectionsV198.home-offers-wide-v206,#homeSectionsV195.home-offers-wide-v206,.home-offers-wide-v206{display:flex!important;justify-content:flex-end!important;align-items:stretch!important;gap:16px!important;margin:22px 0 30px!important;padding:0!important;min-height:0!important;overflow:visible!important;background:transparent!important;border:0!important;box-shadow:none!important}
    #homeSectionsV198.home-offers-wide-v206:empty,#homeSectionsV195.home-offers-wide-v206:empty{display:none!important}
    .home-offer-banner-v206{position:relative!important;width:min(100%,390px)!important;min-height:118px!important;border-radius:22px!important;overflow:hidden!important;border:1px solid rgba(73,219,255,.34)!important;background:#071321!important;color:#fff!important;text-align:right!important;padding:16px 18px!important;box-shadow:0 18px 46px rgba(0,0,0,.35),0 0 0 1px rgba(255,216,107,.10) inset!important;isolation:isolate!important;cursor:pointer!important;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease!important}
    .home-offer-banner-v206:hover{transform:translateY(-4px)!important;border-color:rgba(255,216,107,.62)!important;box-shadow:0 24px 58px rgba(0,0,0,.42),0 0 28px rgba(255,216,107,.14)!important}
    .home-offer-banner-v206 img{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;object-fit:cover!important;opacity:.78!important;filter:saturate(1.08) contrast(1.05)!important;z-index:-2!important}
    .home-offer-banner-v206:after{content:''!important;position:absolute!important;inset:0!important;background:linear-gradient(90deg,rgba(4,11,24,.96),rgba(4,11,24,.52),rgba(4,11,24,.18))!important;z-index:-1!important;pointer-events:none!important}
    .home-offer-banner-v206 span,.home-offer-banner-v206 b,.home-offer-banner-v206 small{position:relative!important;z-index:1!important;display:block!important;text-shadow:0 2px 12px rgba(0,0,0,.72)!important}
    .home-offer-banner-v206 span{width:max-content!important;margin-inline-start:auto!important;background:#54e6b0!important;color:#061421!important;border:0!important;border-radius:999px!important;padding:6px 10px!important;font-size:11px!important;font-weight:1000!important}
    .home-offer-banner-v206 b{font-size:20px!important;margin-top:18px!important;line-height:1.15!important;font-weight:1000!important}
    .home-offer-banner-v206 small{font-size:12px!important;color:#e8f7ff!important;margin-top:5px!important}
    #exclusiveOfferV168{width:min(100%,520px)!important;min-height:130px!important;border-radius:22px!important;margin:22px 0 30px auto!important;overflow:hidden!important}
    @media(max-width:680px){
      #gamesHome .game-cards-grid{grid-template-columns:1fr!important;gap:18px!important;padding-top:20px!important}
      #gamesHome .moba-game-tile-v206{min-height:154px!important;border-radius:20px!important}
      #gamesHome .moba-game-tile-v206 b{font-size:20px!important;right:18px!important;left:18px!important;bottom:46px!important}
      #gamesHome .moba-game-tile-v206 small{right:18px!important;left:18px!important}
      #homeSectionsV198.home-offers-wide-v206,#homeSectionsV195.home-offers-wide-v206,.home-offers-wide-v206{display:grid!important;grid-template-columns:1fr!important;margin:16px 0 24px!important;gap:14px!important}
      .home-offer-banner-v206{width:100%!important;min-height:112px!important;border-radius:20px!important}
      #exclusiveOfferV168{width:100%!important;margin:16px 0 24px!important}
    }
  `;
  document.head.appendChild(style);
  function run(){normalizeOffers();renderGamesFinal();}
  document.addEventListener('DOMContentLoaded',()=>{run();setTimeout(run,250);setTimeout(run,900);setTimeout(run,1600);setTimeout(run,2600);});
  window.addEventListener('load',()=>{run();setTimeout(run,350);setTimeout(run,1800);});
})();
...
(function(){
  ...
  document.head.appendChild(css);
  /* v207: disabled old v205 renderer because it overwrote the final visible game cards. */
...
/* moba-v208-run-after-legacy-tail */
(function(){
  function runFinal(){
    try{window.__mobaV208ApplyCatalog&&window.__mobaV208ApplyCatalog();}catch(_){}
    try{window.__mobaV208RenderOffer&&window.__mobaV208RenderOffer();}catch(_){}
    try{window.renderProducts&&window.renderProducts();}catch(_){}
  }
  document.addEventListener('DOMContentLoaded',()=>{setTimeout(runFinal,80);setTimeout(runFinal,650);setTimeout(runFinal,1600);setTimeout(runFinal,2800);});
  window.addEventListener('load',()=>{setTimeout(runFinal,160);setTimeout(runFinal,1500);});
})();
