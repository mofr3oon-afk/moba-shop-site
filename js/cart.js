...
(function(){
  ...
  async function settings(){try{const r=await fetch('/api/settings?ts='+Date.now(),{cache:'no-store'}); const d=await r.json(); return d&&d.settings||{};}catch(e){return {};}}
  ...
  async function boot(){
    ...
    document.body.classList.add('moba-settings-ready'); document.body.classList.remove('moba-catalog-loading');
  }
  document.addEventListener('click',function(e){
