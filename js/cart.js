...
(function(){
  ...
  function addToCart(i){
    ...
    const item = {
      ...
      pubgId,pubgName:name,name,qty,qtyTotal:qty,ucTotal:Number(p.uc||0)*qty,game:'PUBG Mobile',noQty:!!p.noQty
    };
    const c = getCart();
    ...
    root.innerHTML=`
      ...
      <section data-v161-panel="pay" hidden>
        <form id="orderForm" class="clean-pay-form-v161" novalidate>
          ...
          ${couponBreakdownHtml(t)}
          ${t.discount?`<div class="clean-warning-v161">الكوبون ${esc(t.coupon?.code||'')} متطبق على الطلب، والخصم ظاهر في الملخص وفي لوحة الأدمن.</div>`:''}
