...
(function(){
  ...
  const BASE_GAMES=[
    {key:'pubg',title:'PUBG Mobile',subtitle:'UC | ازدهار | برايم',status:'available',sort_order:1,image:'assets/game-covers/pubg.webp',active:true},
    {key:'freefire',title:'Free Fire',subtitle:'Diamonds',status:'soon',sort_order:2,image:'assets/game-covers/freefire-new.webp',active:true},
    {key:'roblox',title:'Roblox',subtitle:'Robux',status:'soon',sort_order:3,image:'assets/game-covers/roblox.webp',active:true},
    {key:'blood_mena',title:'Blood Strike MENA',subtitle:'MENA Top Up',status:'soon',sort_order:4,image:'assets/game-covers/blood_mena.jpg',active:true},
    {key:'blood_global',title:'Blood Strike Global',subtitle:'Global Top Up',status:'soon',sort_order:5,image:'assets/game-covers/blood_global.jpg',active:true},
    {key:'kingshot',title:'King Shot',subtitle:'Top Up',status:'soon',sort_order:6,image:'assets/game-covers/kingshot.webp',active:true},
    {key:'8ball',title:'8 Ball Pool',subtitle:'Coins / Cash',status:'soon',sort_order:7,image:'assets/game-covers/8ball.webp',active:true},
    {key:'goal_battle',title:'Goal Battle',subtitle:'Top Up',status:'soon',sort_order:8,image:'assets/game-covers/goal_battle.webp',active:true}
  ];
  ...
  document.addEventListener('click',function(e){
    ...
    const status=game.dataset.gameStatus||'soon'; const key=game.dataset.game||'pubg';
    if(status!=='available'){
...
(function(){
  ...
  async function loadProductOverrides(){
    ...
    try{
      ...
      const dynamicSections = d && d.settings && Array.isArray(d.settings.dynamic_sections) ? d.settings.dynamic_sections : [];
  ...
  function renderProducts(){
    ...
    const list = (PRODUCTS[cat] || []).filter(p=>!p.game || p.game===activeGame || activeGame==='pubg');
  ...
  function addToCart(i){
    ...
    const item = {
      ...
      pubgId,pubgName:name,name,qty,qtyTotal:qty,ucTotal:Number(p.uc||0)*qty,game:p.game||'PUBG Mobile',noQty:!!p.noQty
    };
    const c = getCart();
