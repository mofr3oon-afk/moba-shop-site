...
(function(){
  ...
  function refreshCouponInCart(){
    ...
    if(rm) rm.onclick = function(){
      window.appliedCoupon = null;
      sessionStorage.removeItem('moba_coupon');localStorage.removeItem('moba_coupon');
  ...
  async function applyCoupon(){
    ...
    try{
      ...
      sessionStorage.setItem('moba_coupon', JSON.stringify(window.appliedCoupon));
  ...
  setTimeout(()=>{
    try{
      const saved = JSON.parse(sessionStorage.getItem('moba_coupon') || 'null');
      if(saved && saved.code){
...
(function(){
  ...
  async function safeApplyCoupon(e){
    ...
    try{
      ...
      window.appliedCoupon=data.coupon;
      try{sessionStorage.setItem('moba_coupon',JSON.stringify(window.appliedCoupon));}catch(e){}
