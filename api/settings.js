...
const PUBLIC_KEYS = ['store_status','store_message','store_status_message','work_status','work_status_message','work_hours','product_overrides','dynamic_products','dynamic_sections','exclusive_offer','game_settings','policy_text','maintenance_mode','payment_settings','brand_settings'];
...
export default async function handler(req,res){
  ...
  try{
    ...
    if(req.method === 'POST'){
      ...
      const allowed = ['store_status','store_message','work_status','work_status_message','work_hours','blacklist_phones','blacklist_ips','blacklist_device_ids','blacklist_pubg_ids','trusted_admin_devices','trusted_admin_ips','product_overrides','dynamic_products','dynamic_sections','exclusive_offer','game_settings','coupon_rules','maintenance_mode','payment_settings','policy_text','store_status_message','vip_phones','customer_notes','staff_settings','sla_minutes','admin_notifications','payment_settings','payment_history','trusted_admin_device_meta','blacklist_entries','client_error_logs','brand_settings'];
